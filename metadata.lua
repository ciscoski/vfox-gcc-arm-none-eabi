...
--- Plugin homepage
PLUGIN.homepage = "https://github.com/ciscoski/vfox-gcc-arm-none-eabi"
...
NOTE:
 ...
 --]]
PLUGIN.manifestUrl = "https://github.com/ciscoski/vfox-gcc-arm-none-eabi/releases/download/manifest/manifest.json"
